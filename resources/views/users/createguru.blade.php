    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        <div class="col-lg-12">
            <div class="panel panel-info">
                <div class="panel-heading">Tambah Data Users Guru
	...
	<div class="container">
		<div class="col-md-8">
				<form id="input" class="form-horizontal row-fluid" enctype="multipart/form-data" method="POST" action="{{ route('users.store') }}">
					...
					<input name="role" type="hidden" class="form-control" value="Guru" required>

								<!--Username-->
					<div class="form-group">
							<label>Guru</label>
							<select id="id" name="id_guru" class="js-example-basic-multiple form-control" required>
                            ...
                            <span class="invalid-feedback" role="alert">
                                <strong class="text-danger">{{ $errors->first('id_guru') }}</strong>
                            </span>
                    		@endif
					</div>
